import getopt
import sys
from modelTrainer.feature_importance import model_train_with_feature_importance

def main(argv):
    unix_options = "ho:t:s:n:e:i:f:"
    gnu_options = ["help", "output_dir=","training_set=", "test_set=", "name=", "eval_metric=", "images_path=",
                   "feature_to_analyze="]
    args1 = []
    try:
    ...
    for currentArgument, currentValue in arguments:
        if currentArgument in ("-h", "--help"):
            print("'main_training.py -o <output_dir> -t <training_set> -s <test_set> -n <name> -e <eval_metric> -i <images_path> -f <feature_to_analyze>'")
            sys.exit(1)
    ...
    model_train_with_feature_importance.train_model(*args1)
